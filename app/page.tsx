...
export default function Home() {
    ...
    const tags = ["Free Verse", "Formal", "Poetic", "Short"]; // Define your tags here
    ...
    return (
        ...
        >
            {/* Textarea */}
            <div className="relative left-0 max-w-3xl mx-auto"> {/* Changed this line */}
                {/* Tags Dropdown */}
				{/* this is for tag area placement */}
