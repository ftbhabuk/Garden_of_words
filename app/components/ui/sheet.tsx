...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        sheetVariants({ side }),
        "bg-gradient-to-br from-white to-gray-50", // Elegant gradient background
        className
      )}
      style={{
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 opacity-70 ring-offset-white transition-all hover:opacity-100 hover:bg-gray-100/80 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
        <X className="h-4 w-4" />
