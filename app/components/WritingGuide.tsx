...
const TechniqueCard: React.FC<TechniqueCardProps> = ({ 
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-gray-900/50 backdrop-blur-sm p-6 rounded-lg border border-gray-800 hover:bg-gray-800/50 transition-all duration-300"
    >
      ...
      <button
        ...
        className="w-full text-left flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-gray-700 hover:bg-gray-700/50 transition-all duration-200"
      >
...
const PoetryFormCard: React.FC<PoetryFormCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-800/50 p-4 rounded-lg mb-3 border border-gray-700">
        <p className="text-gray-300 italic font-serif text-sm leading-relaxed whitespace-pre-line">{example}</p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-4">
        <span className="text-xs text-gray-500 bg-gray-800 px-2 py-1 rounded">{difficulty}</span>
        <span className="text-xs text-gray-500 bg-gray-800 px-2 py-1 rounded">{duration}</span>
      </div>
      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="overflow-hidden"
          >
            <div className="mt-3 p-4 bg-gray-900/30 rounded-lg border border-gray-800">
      ...
      <section className="py-20 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            />
            <h2 className="text-4xl sm:text-5xl font-light text-white mb-6 tracking-tight">Master the Craft</h2>
          ...
          >
            ...
            />
            <h3 className="text-2xl font-light text-white mb-3">Essential Techniques</h3>
          ...
          >
            <motion.div
              ...
              className="h-px bg-gray-600 mb-6"
            />
            <h3 className="text-2xl font-light text-white mb-3">Classical Forms</h3>
            <p className="text-gray-400 max-w-2xl mb-10 font-light">
          ...
          >
            <motion.div
              ...
              className="h-px bg-gray-600 mb-6"
            />
            <h3 className="text-2xl font-light text-white mb-3">Writing Exercises</h3>
            <p className="text-gray-400 max-w-2xl mb-10 font-light">
